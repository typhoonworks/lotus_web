defmodule Lotus.Web.EditorComponents do
  ...
  def input(assigns) do
    ...
    ~H"""
    <fieldset class={[
      "group border rounded-md bg-white h-[41px]",
      ...
      <div class="flex items-center px-2 h-full cursor-text">
        <input
          type={@type}
          name={@name}
          id={@id}
          ...
          class={[
            "w-full border-0 bg-transparent focus:ring-0 text-sm py-1 focus:placeholder:hidden",
